...
class Date_Interval_Type implements Doctrine_Type_Descriptor
{
    public function get_type(): string
    {
        return \Doctrine\DBAL\Types\Date_Interval_Type::class;
    }
    public function get_writable_to_property_type(): Type
    {
        return new Object_Type(DateInterval::class);
    }

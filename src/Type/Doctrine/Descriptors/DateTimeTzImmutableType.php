...
class Date_Time_Tz_Immutable_Type implements Doctrine_Type_Descriptor
{
    public function get_type(): string
    {
        return \Doctrine\DBAL\Types\Date_Time_Tz_Immutable_Type::class;
    }
    public function get_writable_to_property_type(): Type
    {
        return new Object_Type(DateTimeImmutable::class);
    }
